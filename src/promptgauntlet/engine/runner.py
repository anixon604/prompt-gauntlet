...
from promptgauntlet.config import BenchConfig
from promptgauntlet.engine.prompter import HumanPrompter, Prompter, ScriptedPrompter
from promptgauntlet.engine.trace import TraceWriter
...
from promptgauntlet.types import Message, Response, Role, ToolCallResult

if TYPE_CHECKING:
    from promptgauntlet.adapters.base import ModelClient
...
def run_batch(config: BenchConfig) -> str:
    ...
    console.print(f"\n[bold]PromptGauntlet Run: {run_id}[/bold]")
