"""CLI entrypoint for PromptGauntlet."""

from __future__ import annotations

import click

from promptgauntlet import __version__


@click.group()
@click.version_option(version=__version__, prog_name="promptgauntlet")
def main() -> None:
...
def run(
    ...
    from promptgauntlet.config import load_config, merge_cli_overrides
    from promptgauntlet.engine.runner import run_batch
...
def human(scenario: str, model: str, config_path: str | None) -> None:
    ...
    from promptgauntlet.config import load_config, merge_cli_overrides
    from promptgauntlet.engine.runner import run_human
...
def grade(run_id: str) -> None:
    ...
    from promptgauntlet.engine.replay import replay_and_grade
...
def report(run_id: str, formats: str) -> None:
    ...
    from promptgauntlet.grading.report import generate_report
